...
class IsaacgymHandler(BaseSimHandler):
    ...
    def _load_robot_assets(self) -> None:
        ...
        for i, dof_name in enumerate(dof_names):
            ...
            if i_control_mode == "effort":
                ...
                robot_dof_props["armature"][i] = i_actuator_cfg.armature
            ...
            # built-in position mode
                ...
                if i_actuator_cfg.armature is not None:
                    robot_dof_props["armature"][i] = i_actuator_cfg.armature
    ...
    def _make_envs(
        ...
        for i in range(self.num_envs):
            ...
            # # carefully add robot with self-collision enabled
            ...
            self.gym.set_asset_rigid_shape_properties(robot_asset, robot_rigid_shape_props_asset)
            # random mass
