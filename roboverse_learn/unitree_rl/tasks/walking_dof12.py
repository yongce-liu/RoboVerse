...
from roboverse_learn.unitree_rl.configs.cfg_base import BaseEnvCfg, RslTrainCfg
...
@configclass
class WalkingDof12TrainCfg(RslTrainCfg):
    ...
    class algorithm(RslTrainCfg.algorithm):
        entropy_coef = 0.01

    class runner(RslTrainCfg.runner):
