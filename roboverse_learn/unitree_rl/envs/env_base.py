...
class AgentEnv:
    ...
    def __init__(self, simulator: MasterSimulator, robot: RobotCfg) -> None:
        ...
        self._initial_state: TensorState = self._get_initial_state()
    ...
    def reset(self, env_ids: list[int] = None, states: TensorState = None) -> TensorState:
        ...
        states_to_set = self._initial_state if states is None else states
    ...
    def _observation(self, env_states: TensorState) -> TensorState:
        """Get the Observation of the environment."""
        raise NotImplementedError

    def _privileged_observation(self, env_states: TensorState) -> TensorState | None:
