...
@configclass
class FrankaUrdfCfg(RobotCfg):
    name: str = "franka"
    num_joints: int = 9
    # filepath: str = "roboverse_data/robots/franka_rlafford/robots/franka_panda.urdf"
    urdf_path: str = "roboverse_data/robots/franka_rlafford/robots/franka_panda.urdf"
